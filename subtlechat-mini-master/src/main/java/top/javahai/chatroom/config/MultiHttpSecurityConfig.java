...
//    }
    ...
    @Override
    public void configure(WebSecurity web) throws Exception {
      web.ignoring().antMatchers("/login","/verifyCode","/file","/ossFileUpload","/user/checkUsername","/user/checkNickname","/user/mailVerifyCode","/user/reg","/user/loginMailVerifyCode");
    }
    //登录验证
    @Override
    protected void configure(HttpSecurity http) throws Exception {
